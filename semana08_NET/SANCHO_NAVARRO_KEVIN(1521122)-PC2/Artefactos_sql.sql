USE master
SET  DATEFORMAT ymd
IF EXISTS(SELECT * FROM sysdatabases WHERE name='bdArtefacto')
    begin
	DROP DATABASE  bdArtefacto
	--GO
    end
...
CREATE TABLE proforma (
	nro_pro char (5) NOT NULL Primary Key ,
...
Create Table Calendario(
  nro_pro char(5) not null,
  nro_cuota int not null,
	monto    decimal(10,1),
	saldo    decimal(10,1),
	fecha    datetime,
	primary key(nro_pro,nro_cuota))  
...
insert into proforma values('P0001','C0001','A0002',1200,'A') 


INSERT INTO Clientes VALUES ('C0001','Chuquiara Sulla,Ana',1234567,54336725321,'Av. La Marina 1234') 
INSERT INTO Clientes VALUES ('C0002','Peña Inafuku, carlos',6584503,56325236234,'Av. Pardo 456     ') 
...
INSERT INTO Clientes VALUES ('C0009','MONICA GONZALES  ',7894073,67233674566,'Av. Iquitos 228   ') 
